...
export const metadata: Metadata = {
  ...
  description: "Receba gratuitamente a liturgia católica diária em seu e-mail. Leituras, salmos, evangelho e reflexões para fortalecer sua fé todas as manhãs.",
  alternates: {
  ...
  return (
    <>
      <article className="text-center max-w-md mx-auto space-y-8">
        ...
        <div className="relative w-20 h-20 mx-auto mb-6 rounded-full bg-amber-100 flex items-center justify-center" role="img" aria-label="Cruz cristã">
      ...
      <JsonLd
        data={{
          ...
          description: "Serviço de newsletter gratuito que envia a liturgia católica diária por e-mail todas as manhãs",
